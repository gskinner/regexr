...
class solve extends \core\AbstractAction {
		...
		public function execute() {
            ...
            if ($mode == "text") {
                $result = $this->parseText($pattern, $modifiers, $text, $tool, $global);
            } else if ($mode == "tests") {
                $result = $this->runTests($tests, $pattern, $modifiers, $global);
            } else {
        ...
        function parseText($pattern, $modifiers, $text, $tool, $global) {
